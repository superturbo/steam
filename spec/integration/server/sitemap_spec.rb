...
describe Locomotive::Steam::Server do
  ...
  <url>
    ...
    context 'existing sitemap page' do
      ...
      let(:page)      { instance_double('Page', liquid_source: template, templatized?: false, redirect?: false, to_liquid: template, not_found?: false, response_type: 'application/xml', fullpath: 'sitemap') }
